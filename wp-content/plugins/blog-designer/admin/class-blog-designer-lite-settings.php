...
class Blog_Designer_Lite_Settings {
									...
									<div class="bd-right">
										...
										<select data-placeholder="<?php esc_attr_e( 'Choose Post Categories', 'blog-designer' ); ?>" class="chosen-select" multiple style="width:220px;" name="template_category[]" id="template_category">
											<?php foreach ( $categories as $category_obj ) : ?>
												...
												<?php
												if ( @in_array( $category_obj->term_id, $settings['template_category'] ) ) { //phpcs:ignore
									...
									<div class="bd-right">
										...
										<select data-placeholder="<?php esc_attr_e( 'Choose Post Authors', 'blog-designer' ); ?>" class="chosen-select" multiple style="width:220px;" name="template_authors[]" id="template_authors">
											<?php foreach ( $blogusers as $user ) : ?>
												...
												<?php
												if ( @in_array( $user->ID, $template_authors ) ) { //phpcs:ignore
													echo 'selected="selected"';
												}
												?>
								...
								<li class="pro-feature">
									...
									<div class="bd-right">
										...
										<fieldset class="buttonset">
											...
											<label for="bdp_post_title_link_1" class="ui-corner-left"><?php esc_html_e( 'Yes', 'blog-designer' ); ?></label>
								...
								<li class="excerpt_length">
									...
									<div class="bd-right">
										...
										<fieldset class="buttonset">
											...
											<label for="display_html_tags_1" class="ui-corner-left"><?php esc_html_e( 'Yes', 'blog-designer' ); ?></label>
								...
								<li>
									...
									<div class="bd-right">
										...
										<fieldset class="bdp-social-options bdp-display_slider_controls buttonset buttonset-hide ui-buttonset">
											...
											<label for="display_slider_controls_1" class="ui-corner-left" <?php checked( 1, $display_slider_controls ); ?>><?php esc_html_e( 'Yes', 'blog-designer' ); ?></label>
								...
								<li>
									...
									<div class="bd-right">
										...
										<fieldset class="bdp-social-options bdp-slider_autoplay buttonset buttonset-hide ui-buttonset">
											...
											<label for="slider_autoplay_1" class="ui-corner-left" <?php checked( 1, $slider_autoplay ); ?>><?php esc_html_e( 'Yes', 'blog-designer' ); ?></label>
								...
								<li class="pro-feature">
									...
									<div class="bd-right">
										...
										<fieldset class="buttonset">
											...
											<label for="bdp_post_image_link_1" class="ui-corner-left"><?php esc_html_e( 'Enable', 'blog-designer' ); ?></label>
								...
								<li>
									...
									<div class="bd-right">
										...
										<fieldset class="bdp-social-options buttonset buttonset-hide" data-hide='1'>
											...
											<label id="social_share_1" for="social_share_1" class="ui-corner-left" <?php checked( 1, get_option( 'social_share' ) ); ?>><?php esc_html_e( 'Enable', 'blog-designer' ); ?></label>
										...
										<div class="bd-typography-cover">
											...
											<div class="bd-typography-content">
												<fieldset class="buttonset">
													...
													<label for="facebook_link_0" class="ui-corner-left"><?php esc_html_e( 'Yes', 'blog-designer' ); ?></label>
										...
										<div class="bd-typography-cover">
											...
											<div class="bd-typography-content">
												<fieldset class="buttonset">
													...
													<label for="linkedin_link_0" class="ui-corner-left"><?php esc_html_e( 'Yes', 'blog-designer' ); ?></label>
										...
										<div class="bd-typography-cover">
											...
											<div class="bd-typography-content">
												<fieldset class="buttonset">
													...
													<label for="pinterest_link_0" class="ui-corner-left"><?php esc_html_e( 'Yes', 'blog-designer' ); ?></label>
										...
										<div class="bd-typography-cover">
											...
											<div class="bd-typography-content">
												<fieldset class="buttonset">
													...
													<label for="twitter_link_0" class="ui-corner-left"><?php esc_html_e( 'Yes', 'blog-designer' ); ?></label>
	 ...
	 * Display Optin form
	 */
	public function bd_welcome_function() {
		global $wpdb;
